...
function DetailStep({ form, type, update }: StepProps) {
  ...
  if (type === "organisation") return <>
    ...
    <div className="field-row">
      ...
      <Field label="Presence type" required><select onChange={(event) => update("presenceType", event.target.value)} required value={form.presenceType}><option value="operations">Operations</option><option value="project_participation">Project participation</option><option value="office">Office</option><option value="warehouse">Warehouse</option><option value="legal_entity">Registered entity</option><option value="product_deployment">Product deployment</option><option value="product_availability">Product availability</option></select></Field>
    </div>
